export const localizations = {
  ...
  banNewTelegramUsers_true: {
    en:
      'Nice! Shieldy will ban (or kick) all newcomers with Telegram ID greater than given.',
    ru:
      'Отлично! Щилди будет банить (или кикать) пользователей, у которых Телеграм ID больше заданного.',
    bg:
  ...
  banNewTelegramUsers_false: {
    ru:
      'Отлично! Щилди не будет банить (или кикать) пользователей, у которых Телеграм ID больше заданного.',
    en:
      'Nice! Shieldy will no ban (or kick) all newcomers with Telegram ID greater than given.',
    bg:
      'Чудесно! Shieldy няма да забранява (или да "изрита") никой новодошъл с Telegram ID над 1 000 000 000.',
  },
  banChatCopies_true: {
    en:
      'Nice! Shieldy will ban (or kick) all users whose names are similar to the chat name.',
    ru:
      'Отлично! Щилди будет банить (или кикать) пользователей, у которых имя похоже на название чата.',
  },
  banChatCopies_false: {
    ru:
      'Отлично! Щилди не будет банить (или кикать) пользователей, у которых имя похоже на название чата.',
    en:
      'Nice! Shieldy will not ban (or kick) all users whose names are similar to the chat name.',
  },
  oneInchInfo: {
    en:
